...
const faqs = [
    ...
    },
    {
        ...
        answer:
            "The DELE Escolares covers A1 and A2/B1 levels of the Common European Framework of Reference for Languages (CEFR).",
    },
    {
    ...
    },
    {
        ...
        answer:
            "The A1 exam consists of Reading (45 min), Listening (20 min), Writing (25 min), Oral (30 min: 15+15); the A2 exam has Reading (60 min), Listening (35 min), Writing (50 min), Oral (30 min).",
    },
];
            ...
            {/* <div className="w-full max-w-6xl my-2 space-y-4 px-8 md:px-12"> */}
                {/* {faqs.map((faq, index) => (
                    <motion.div
                        ...
                        className="bg-[#5D17EB] text-white rounded-md shadow-md overflow-hidden"
                    >
                        <button
                        ...
                        <AnimatePresence>
                            {openIndex === index && (
                                <motion.div
                                    ...
                                    className="text-left px-6 pb-4 text-[16px] bg-[#5D17EB] text-white rounded-b-md"
                                >
                                    {faq.answer}
                                </motion.div>
                            )}
