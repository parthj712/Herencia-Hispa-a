    ...
    return (
        <div className="pb-4">
            <motion.section
                ...
                animate={{
                    backgroundPosition: ["0% 50%", "100% 55%", "0% 50%"],
                }}
                transition={{
                    duration: 30,
                    repeat: Infinity,
            ...
            >
                <div className="pl-10 md:pl-16 lg:pl-20 relative z-10 max-w-7xl text-left text-white px-8 pb-12">
                    ...
                    <p className="text-lg md:text-xl drop-shadow-[0_1px_3px_rgba(0,0,0,0.6)]">
                        ...
                        Whether you're preparing for the DELE Spanish exam or starting as a beginner, our
                        affordable Spanish language courses help you master real-world conversations at your own pace.
                    </p>
                </div>
            </motion.section>
        </div>
