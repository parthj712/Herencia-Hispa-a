...
const Testimonials = () => {
  ...
  const fetchData = async () => {
    try {
      const res = await API.get("testimonials/active-testimonials");
      setData(res.data);
    } catch (error) {
    ...
    >
      ...
      >
        <div className="relative max-w-6xl mx-auto px-4 z-10 py-2">
                  ...
                  <div className="py-16 lg:py-0 md:py-0 relative rounded-b-2xl rounded-tr-2xl p-0 lg:p-6 md:p-6 text-left text-black">
                    ...
                    <div className="px-8 lg:px-16 md:px-16 flex flex-col items-center">
                      <div className="flex items-center gap-4">
                        <div>
                          <h4 className="text-[#FDB900] font-semibold text-[26px] lg:text-3xl md:text-2xl text-center">
                            {test.fullName}
                          </h4>
                      ...
                      <span className="text-[22px] text-[#FDB900] shadow-2xl">
                        •
                      </span>
          ...
          <p className="lg:hidden md:hidden text-[16px] pt-0 lg:pt-9 md:pt-9">
            Swipe to see more
          </p>
        </div>
      </section>
