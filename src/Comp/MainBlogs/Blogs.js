                ...
                <div className="flex flex-col items-center justify-center py-12">
                    ...
                    <div className="px-8 lg:px-4 md:px-0 w-full max-w-4xl lg:max-w-7xl md:max-w-2xl flex flex-col items-center">
                        <Box display={"flex"} flexDirection={"column"} gap={2} py={isMobile ? 4 : isTablet ? 6 : 8}>
                            <p className='text-[17px] lg:text-[22px] md:text-[18px] text-center'>Welcome to The Instructor's Guide by Herencia Hispaña. This is your essential hub for mastering Spanish and conquering the official DELE certification. Dive into expert strategies, exclusive grammar deep dives, and cultural insights straight from our certified CEO and Master Instructor, Mr. Amey Prabhudesai.</p>
                        </Box>
